    ...
    create(context, [options], helpers) {
        ...
        const getFireEventMethodName = (callExpressionNode, node) => {
            if (!experimental_utils_1.ASTUtils.isIdentifier(callExpressionNode.callee) &&
                !node_utils_1.isMemberExpression(callExpressionNode.callee)) {
                return node.name;
            }
            ...
            if (!node_utils_1.isCallExpression(secondArgument) ||
        ...
        return {
            ...
            VariableDeclarator(node) {
                ...
                if (node_utils_1.isMemberExpression(node.init.callee) &&
